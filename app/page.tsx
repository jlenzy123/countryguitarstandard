export default function Home() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      <h1 className="font-display text-4xl font-bold text-cream tracking-tight">
        Country guitar songwriting resources<br />for writers and players.
      </h1>
      ...
      <div className="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
        <a
          href="/guides"
          className="group block rounded-lg bg-void-card p-6 transition hover:bg-void-card/90 border-l-4 border-denim"
        >
          <h2 className="font-display font-semibold text-cream group-hover:text-gold transition-colors">Guides & Reports</h2>
        ...
        <a
          href="/songwriting"
          className="group block rounded-lg bg-void-card p-6 transition hover:bg-void-card/90 border-l-4 border-saddle"
        >
          <h2 className="font-display font-semibold text-cream group-hover:text-gold transition-colors">Songwriting Template</h2>
          <p className="mt-2 text-sm text-cream-muted">
        ...
        <a
          href="/shop"
          className="group block rounded-lg bg-void-card p-6 transition hover:bg-void-card/90 border-l-4 border-gold"
        >
          <h2 className="font-display font-semibold text-cream group-hover:text-gold transition-colors">Shop Products</h2>
          <p className="mt-2 text-sm text-cream-muted">
        ...
        <a
          href="/chord-tool"
          className="group block rounded-lg bg-void-card p-6 transition hover:bg-void-card/90 border-l-4 border-barn"
        >
          <h2 className="font-display font-semibold text-cream group-hover:text-gold transition-colors">Chord Tool</h2>
          <p className="mt-2 text-sm text-cream-muted">
      ...
      <div className="mt-16 rounded-lg bg-denim/20 border border-denim/50 p-8 text-center">
      ...
      <section className="mt-24">
        <h2 className="text-2xl font-semibold text-cream mb-6">Frequently Asked Questions</h2>
        <div className="space-y-4">
          <details className="group rounded-lg bg-void-card p-4" open>
            <summary className="flex justify-between items-center cursor-pointer text-cream font-medium">
              <span>What is the Nashville Number System?</span>
              <span className="ml-4 text-cream-muted group-open:rotate-180 transition-transform">▾</span>
            </summary>
          ...
          <details className="group rounded-lg bg-void-card p-4">
            <summary className="flex justify-between items-center cursor-pointer text-cream font-medium">
